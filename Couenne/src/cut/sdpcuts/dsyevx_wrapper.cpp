...
void dsyevx_wrapper_only_positive (int n, double *A, int &m, double * &w, double * &z) {
  _dsyevx_value_range_wrapper (n,A,m,w,z,ABS_TOL_EIG,0.0,COIN_DBL_MAX);
}

void dsyevx_wrapper_only_negative (int n, double *A, int &m, double * &w, double * &z) {
  _dsyevx_value_range_wrapper (n,A,m,w,z,ABS_TOL_EIG,-COIN_DBL_MAX,ABS_TOL_EIG);
}

void dsyevx_wrapper_only_most_neg (int n, double *A, int &m, double * &w, double * &z) {
  _dsyevx_index_range_wrapper (n,A,m,w,z,ABS_TOL_EIG,1,1);
}

void dsyevx_wrapper_first_p (int n, double *A, int &m, double * &w, double * &z, int p) {
